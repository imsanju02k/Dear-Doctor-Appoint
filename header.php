...
<body>
	<div class="container-fluid">
		<div class="header_top">
			...
			<span style="font-size:50px;color:#2c2f84;font-weight:bolder;margin-left:15px;"> Dear Doctor Appoinment System</span>
		</div>
	...
	<div class="navbar navbar-default nav">
		<nav class="menu">
			<ul>
				...
				<li><a href="http://localhost:8080/Doctor%20Appointment%20System/admin/">Admin</a></li>
				<li><a href="https://www.netmeds.com/">Pharmacy</a></li>
